...
<body>
	<h2>회원가입</h2>
	<form name="personFrm" action="${pageContext.request.contextPath}/handler.do" method="post" accept-charset="UTF-8">
		<table>
			<tr>
				<td class="Mytd">성명</td>
	...
	<script type="text/javascript">
		function goSubmit(flag){
			var frm = document.personFrm; //personFrm이라는 Form을 가져와서 frm 변수에 담음
			if(flag == 0){
				frm.view.value = "02_scriptlet.jsp"; //frm의 39행 hidden input에 02_scriptlet.jsp페이지를 집어 넣음
			} else if(flag == 1){
